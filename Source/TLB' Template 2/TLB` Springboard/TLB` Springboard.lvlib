...
<Library LVVersion="15008000">
	...
	<Item Name="Components" Type="Folder">
		<Item Name="Core" Type="Folder">
			...
			<Item Name="SHIFTER - TLB` Springboard.vi" Type="VI" URL="../Components/SHIFTER - TLB` Springboard.vi"/>
			<Item Name="TypeDef - SHIFTER - TLB` Springboard.ctl" Type="VI" URL="../Components/TypeDef - SHIFTER - TLB` Springboard.ctl"/>
		</Item>
	...
	<Item Name="Find and Rename Libraries.vi" Type="VI" URL="../Components/Find and Rename Libraries.vi"/>
	<Item Name="Find and Rename Folders.vi" Type="VI" URL="../Components/Find and Rename Folders.vi"/>
</Library>
