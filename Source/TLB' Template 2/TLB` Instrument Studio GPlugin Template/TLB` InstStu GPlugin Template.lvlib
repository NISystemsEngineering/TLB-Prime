	...
	<Item Name="Core Components" Type="Folder">
		...
		<Item Name="UI" Type="Folder">
			<Item Name="Display" Type="Folder">
				...
				<Item Name="Disable and Grey Control.vi" Type="VI" URL="../Core Components/UI/Display/Disable and Grey Control.vi"/>
				<Item Name="Enable Control.vi" Type="VI" URL="../Core Components/UI/Display/Enable Control.vi"/>
				<Item Name="Pane Slider.vi" Type="VI" URL="../Core Components/UI/Display/Pane Slider.vi"/>
			</Item>
