...
<Library LVVersion="15008000">
	...
	<Item Name="{TMPL} App Components" Type="Folder">
		<Item Name="UI" Type="Folder">
		...
		<Item Name="{TMPL} System Trigger.ctl" Type="VI" URL="../Application Components/Trigger API/{TMPL} System Trigger.ctl"/>
		...
		<Item Name="{TMPL} Error Handler.lvclass" Type="LVClass" URL="../Application Components/Error Handler/{TMPL} Error Handler.lvclass"/>
	...
	<Item Name="TLB` - {TMPL}.lvclass" Type="LVClass" URL="../TLB` - {TMPL}.lvclass"/>
</Library>
